...
public class TransferController {
    ...
    public ResponseEntity<TransactionResultDTO> transfer(@Valid @RequestBody MoneyTransferDTO request) {
        TransactionResultDTO message = transferService.transfer(request);
